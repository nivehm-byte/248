...
Internalise its principles — spatial composition, motion, backgrounds, atmospheric design. Every design decision in this project must reflect that skill's quality bar. No generic AI aesthetics. No purple gradients on white. Bold, intentional, context-appropriate choices only.

---

## Step 0.5: Read the Brand Guide

Read `TFE-brand-guide.md` in the project root. This is the Two Four Eight brand system and it is **law**. Every colour, font choice, corner radius, and layout decision must comply with this guide. Key constraints:

- **Only Inter** as a typeface (400/500/600/700 weights + italics)
- **Only the five brand colours** (#D4C8B8 Sand, #6B775B Olive, #4F6375 Slate, #232322 Charcoal, #8B5936 Earth) plus white/off-white
- **Rounded corners** on everything — cards, buttons, images, containers
- **Asymmetric layouts** preferred over centered/symmetric
- **Spacious** — generous whitespace is a feature, not wasted space
- **Image-led** — photography and texture drive the story, text supports

The brand guide overrides any conflicting defaults from the frontend-design skill. If the skill says "avoid Inter" but the brand says "Inter only" — the brand wins.
